...
@interface InstallViewController (){
    ...
    ManagementViewController *manage;
...
- (IBAction)searchBtn:(id)sender {
    InstalDataViewController *instalData = [[InstalDataViewController alloc] initWithNibName:@"InstalDataViewController" bundle:nil];
    [self presentViewController:instalData animated:YES completion:nil];
