...
- (UITableViewCell *)tableView:(UITableView *)aTableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (cell == nil)
    {
        ...
        UIImage* image = [self addText:[self imageWithColor:[UIColor clearColor]forRect:CGRectMake(0, 0, 100, 20)] text: dataObjectStr];
...
-(UIImage *)addText:(UIImage *)img text:(NSString *)text
{
    ...
    UIFont *font = [UIFont fontWithName:@"Helvetica" size:10.0f];//boldSystemFontOfSize:10];
