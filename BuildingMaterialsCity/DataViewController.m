...
- (void)viewDidLoad {
    ...
    self.searchClass.layer.cornerRadius=0.0f;
    self.searchClass.layer.masksToBounds=YES;
    self.searchClass.layer.borderColor=[UIColor colorWithRed:203.0/255 green:203.0/255 blue:203.0/255 alpha:1].CGColor;
    self.searchClass.layer.borderWidth= 0.5f;
